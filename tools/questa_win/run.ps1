...
if ($Argument -eq "clean") {
    ...
    Remove-Item .\modelsim.ini             -ErrorAction SilentlyContinue
    Remove-Item .\transcript               -ErrorAction SilentlyContinue
    Remove-Item .\vsim.wlf                 -ErrorAction SilentlyContinue
	Remove-Item .\vsim_stacktrace.vstf     -ErrorAction SilentlyContinue
    Remove-Item .\coverage.ucdb            -ErrorAction SilentlyContinue
...
} elseif ($Argument -eq "cpu_pipeline_dbg") {
    vlib work
	vmap work work
	vlog -sv `
		$RTL/cpu_pipeline/top_tb.sv `
